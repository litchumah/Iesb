...
def detect_object(original_image):
    ...
    cv2.putText(original_image, f'NUMBER OF CARS: {count_car}', (50, 50), cv2.FONT_HERSHEY_DUPLEX, 1, (0, 255, 0), 2, cv2.LINE_AA) # putting lable
    cv2.putText(original_image, 'NUMBER OF BUSES: '+str(count_bus), (50, 100), cv2.FONT_HERSHEY_DUPLEX, 1, (0, 255, 0), 2, cv2.LINE_AA) # putting lable
